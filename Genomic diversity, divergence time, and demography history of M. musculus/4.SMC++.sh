...
for j in {1..19}
do
  sudo docker run --rm -v $PWD:/mnt terhorst/smcpp:latest vcf2smc --mask ./mask/chr${j}.mask.bed.gz ./5pop.recode.vcf.gz ./CAS1/CAS1-chr${j}.smc.gz $j CAS1:IN1,IN2,IN3,IN4,IN5,IN6,PA1,PA2,PA3,PA4
done
